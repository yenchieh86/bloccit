...
# add 'SessionsHelper', so we can use the 'create_session(user)' method in spec
...
RSpec.describe PostsController, type: :controller do
  ...
  context "guest user" do
    ...
    describe "GET new" do
      it "returns http redirect" do
        ...
        # expect guest to be 'redirected' if they didn't sign in and try to attempt to CRUD a post
  ...
  # wrap spec below in a context, so they can become signed-in user specs
  context "signed-in user" do
    ...
    describe "GET new" do
      ...
      # use 'render_template' to make sure that 'response from PostsController#new' will give the posts ':new'(new view)
