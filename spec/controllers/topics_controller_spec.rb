...
RSpec.describe TopicsController, type: :controller do
    ...
    context "member user" do
        ...
        before do
            user = User.create!(name: "Bloccit User", email: "user@bloc.com", password: "jack4930", role: :member)
            create_session(user)
        end
    ...
    context "moderator user" do
        before do
            user = User.create!(name: "Blocbit Moderatoruser", email: "moderatoruser@bloc.com", password: "moderatorpassword", role: :moderator)
            create_session(user)
        end
