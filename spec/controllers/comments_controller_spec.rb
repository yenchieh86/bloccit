...
RSpec.describe CommentsController, type: :controller do
    ...
    let(:my_user) { User.create!(name: "Bloccit User", email: "user@bloccit.com", password: "passwordpassword") }
    let(:other_user) { User.create!(name: RandomData.random_name, email: RandomData.random_email, password: "passwordpassword", role: :member) }
    ...
    context "guest" do
        ...
        describe "DELETE destroy" do
            it "redirects the user to the sign in voew" do
